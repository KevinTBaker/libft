...
#    Updated: 2018/03/20 22:55:46 by kbaker           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =  ft_lstnew.c	ft_putchar.c ft_strchr.c ft_strjoin.c ft_strnew.c ft_toupper.c \
		...
		ft_isupper.c ft_swap.c ft_memset.c ft_strcat.c ft_striteri.c ft_strnequ.c ft_itoa.c ft_tolower.c \
...
OBJS = ft_lstnew.o ft_putchar.o ft_strchr.o ft_strjoin.o ft_strnew.o ft_toupper.o \
       ...
       ft_isupper.o ft_swap.o ft_memset.o ft_strcat.o ft_striteri.o ft_strnequ.o ft_itoa.o ft_tolower.o \
